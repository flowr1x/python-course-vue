...
SyntaxError: invalid syntax</code></pre>
              <p>В терминологии языка Python здесь возникло исключение, принадлежащее классу
                  SyntaxError. Согласно документации Python синтаксические ошибки все-таки принято
...
NameError: name 'b' is not defined</code></pre>
              ...
              <p>Если исключение возникает при выполнении кода из файла, то вместо "line 1" будет указана
                  ...
                  По-умолчанию это поток ввода с клавиатуры. Строка 1 – потому что в интерактивном режиме
...
ZeroDivisionError: division by zero</code></pre>
        ...
        <section class="text-manual__doc-section">
            ...
            <div class="text-manual__section-block">
              ...
              <p>В Питоне такой перехват выполняет оператор try-except. "Try" переводится как "попытаться",
                  "except" – как исключение. Словами описать его работу можно так: "Попытаться сделать то-
                  то и то-то, если при этом возникло исключение, то сделать вот это и это." Его конструкция
...
Что-то пошло не так</code></pre>
 ...
 print("Вы ввели не целое число")</code></pre>
              <p>Теперь если сработает тело except мы точно знаем, из-за чего возникла ошибка. Но если в
                  теле try возникнет еще какое-нибудь исключение, то оно не будет обработано. Для него надо
